#!/usr/bin/env python3
"""Run single-quartet validation against frozen Formal T0 v3 R2 inputs."""
...
RUNNER = REPO / "encrypted_traffic_platform/realistic/run_single_quartet_v3_validation_retry.py"
R2_INPUTS = {
...
def load_runner():
    spec = importlib.util.spec_from_file_location("r2_quartet", RUNNER)
...
runner.SUCCESS_MARKER = "REALISTIC_V3_R2_SINGLE_QUARTET_VALIDATION_PASS"


if __name__ == "__main__":
    sys.argv = [
        sys.argv[0],
        "--local-parent", "/home/etip/datasets/staging/realistic_v1/r2_single_quartet_validation",
        "--remote-parent", "/home/dataset-assist-0/duwenbiao/Tunnel/proxydata/realistic_v1/r2_single_quartet_validation",
    ]
