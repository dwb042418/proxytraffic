#!/usr/bin/env python3
"""Run a v3 validation quartet under frozen transient retry policy v2."""
...
POLICY = DOC / "formal_transient_retry_policy_v2.txt"
POLICY_FREEZE = DOC / "formal_transient_retry_policy_v2.sha256"
LEDGER = DOC / "formal_t0_v3_retry_ledger.tsv"
POLICY_SHA256 = "c709bf3746dbb361112a063db3a4b403ed2e2a129f354f3fe68b1d35c2382af2"
...
def retry_authorized(
    attempt_result: dict[str, object], attempt: int = 1,
) -> tuple[bool, str]:
...
def main() -> int:
    ...
    run_id = "single_quartet_v3_validation_retry_v2_" + base.stamp_now()
